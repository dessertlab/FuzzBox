...
// per alcune librerie è importante quindi codificare prima della trasmissione (oppure nel fuzzer) es. con base64 e decodificare con base64
...
#define THROUGHPUT_LBOUND 100 // non a 0 così si supera transitorio e si vede a regime
#define THROUGHPUT_HBOUND 1100
...
#define LINUX_FIRMWARE 1 // firmware example. 0 = mils example

// pc profiling
#define PC_PROFILING 1
#define PC_GATHERING_MODE 0 // this should also not override fuzzing input in tcg or debug_harness function(fuzzing non deve funzionare se è a 1)
// attenzione: per avere unique PCs bisogna usare bitmap_update_ontranslate 1
// Define the maximum number of hex values in the file

#if LINUX_FIRMWARE == 1
#define HASH_SIZE 16777216
#define MAP_SIZE_POW2 24
#define MAX_HEX_VALUES 16777216
#else
#define HASH_SIZE 65536
#define MAP_SIZE_POW2 16
#define MAX_HEX_VALUES 7600
#endif

#define PC_FILE_WRITE "./pc_filtering/firmware_pc3.txt"
#define PC_FILE_READ "./pc_filtering/firmware_pc2.txt" 

#define INIT_WAIT_TIME 10 // initial waiting time
#define INIT_TIMES 2      // wait = INIT_WAIT_TIME * INIT_TIMES

// snapshot settings
#define SNAPSHOT_ENABLED 0      // set this flag also in the TCG plugin
